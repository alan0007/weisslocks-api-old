...
require dirname(dirname(__FILE__)).'/modules/v1/log/controllers/LogActivityController.php';
...
use api\modules\v1\log\controllers\LogActivityController;
    ...
    isset($_REQUEST['description']) )
{
    ...
    $LogActivityController = new LogActivityController($Database);

...
include(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))).'/common/v1/models/KeyGroup.php');

use common\config\Database;
use common\v1\models\KeyGroup;

class KeyGroupController
{

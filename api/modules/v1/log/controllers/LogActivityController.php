...
include(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))).'/common/v1/models/LogActivity.php');

use common\config\Database;
use common\v1\models\LogActivity;
...
class LogActivityController
{
    ...
    public function actionInsert($company_id,$user_id,$description,$category)
    {
        $collection = $this->Database->getCollectionPhp5($this->app_data,$this->Model->tableName());
        $post = array(

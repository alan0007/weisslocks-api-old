        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
					...
					<h3 class="page-header">(Last 10 records)</h3>
                </div>
                <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										//Edited changes
										$user_exclude_list = array(1,179,185,186,187,188,189,190,191,196,197,201,231,237,238,239,252,255,255,262,363,364,265,279);
										...
										if($_SESSION['role'] == 1 || $_SESSION['role'] == 2 || $_SESSION['role'] == 3)
										{
											...
											$cursor = $cursor->sort(array('fire_alarm_id' => -1))->limit(10);
											...
											if($cursor->count() > 0)
											{
												...
												foreach($cursor as $fire_alarm)
												{
													...
													$user_exited_building_after_time_up_list = array();
													...
													$time_before_format = DateTime::createFromFormat($time_format, $alarm_time);
													...
													$exit_building_end_time = date('m/d/Y H:i:s',strtotime('+8 minutes',strtotime($time_after_format)));
													$exit_building_end_time_before_format = DateTime::createFromFormat($american_time_format, $exit_building_end_time);
													$exit_building_end_time_date_first =  $exit_building_end_time_before_format->format('d/m/Y H:i:s');
													
													//$exit_building_extra_time = date('m/d/Y H:i:s',strtotime('+18 minutes',strtotime($alarm_time)));
													$exit_building_extra_time = date('m/d/Y H:i:s',strtotime('+18 minutes',strtotime($time_after_format)));
													$exit_building_extra_time_before_format = DateTime::createFromFormat($american_time_format, $exit_building_extra_time);
													$exit_building_extra_time_date_first =  $exit_building_extra_time_before_format->format('d/m/Y H:i:s');
													
													//$attendance_start_time = date('m/d/Y H:i:s',strtotime('+8 minutes',strtotime($alarm_time)));
													$attendance_start_time = date('m/d/Y H:i:s',strtotime('+8 minutes',strtotime($time_after_format)));
													$attendance_start_time_before_format = DateTime::createFromFormat($american_time_format, $attendance_start_time);
													$attendance_start_time_date_first =  $attendance_start_time_before_format->format('d/m/Y H:i:s');
													
													//$attendance_end_time = date('m/d/Y H:i:s',strtotime('+60 minutes',strtotime($alarm_time)));
													$attendance_end_time = date('m/d/Y H:i:s',strtotime('+60 minutes',strtotime($time_after_format)));
													$attendance_end_time_before_format = DateTime::createFromFormat($american_time_format, $attendance_end_time);
													$attendance_end_time_date_first =  $attendance_end_time_before_format->format('d/m/Y H:i:s');
													...
													*/
													...
													<tr>														
														...
														<?php
															...
															$beacon_exit_list = array("Visitors reception L1","AA 1","AA 2","AA 3","AA 4","AA 5","AA 6","AA 7","AA 8","PA Exit");
															
															//$beacon_assembly_list = array("AA 3","AA 5","AA 8","PA Assembly");
															$beacon_assembly_list = array("AA 1","AA 2","AA 3","AA 5","AA 8","PA Assembly");
...
//IMPORTANT:														//Change format of am and pm that causes fatal error
																	if (strpos($user_last_beacon_time, 'am') !== false || strpos($user_last_beacon_time, 'pm') !== false) {
																		$user_last_beacon_time_formatted = date('m/d/Y H:i:s',strtotime($user_last_beacon_time));
																	}
																	else{																	
																	
																		$user_last_beacon_time_before_format = DateTime::createFromFormat($time_format, $user_last_beacon_time);
																		//Return php error here: 
																		
																		//if ( $user_last_beacon_time_before_format != false ){
																			$user_last_beacon_time_formatted =  $user_last_beacon_time_before_format->format('m/d/Y H:i:s');
																		//}
																	}
																	//$user_last_beacon_time_formatted =  date('m/d/Y H:i:s',$d);
																	//echo $user_last_beacon_time_formatted . ", ";
																	//echo "Created date is " . date("m/d/Y H:i:sa", $d) . "<br>";
																	
																	
																	//$exit_building_start_time = date('m/d/Y H:i:s',strtotime($user_last_beacon_time));
																	//$exit_building_start_time_before_format = DateTime::createFromFormat($time_format, $user_last_beacon_time);
																	//$exit_building_start_time =  $exit_building_start_time_before_format->format('m/d/Y H:i:s');
																	
																	//echo "User: " . $user_last_beacon_time_formatted . ", " . $exit_building_start_time . ", " . $user_last_beacon_time_formatted . ", " . $exit_building_end_time . "<br>";
																	
																	if ( !in_array($user_id, $user_exclude_list) && in_array($user_id, $user_full_list) ){
																		
																		//Exited Building list before time is up
																		...
																		//Exited Building list after time is up
																		if ( in_array( $user_last_beacon_name, $beacon_exit_list) ||  in_array( $user_last_beacon_name, $beacon_assembly_list)){
																			if ( $user_last_beacon_time_formatted >= $exit_building_end_time){
																			
																				if (!in_array($user_id, $user_exited_building_list)){
																					array_push($user_exited_building_after_time_up_list,$user_id);		
																					//echo "User: " . $user_last_beacon_time_formatted . ", " . $exit_building_start_time . ", " . $user_last_beacon_time_formatted . ", " . $exit_building_end_time . "<br>";
															...
															//Exit Building (Before Time Up) Count
															...
															// Exit Building (After Time Up) List
															$user_exited_building_after_time_up_list = array_keys(array_flip($user_exited_building_after_time_up_list));
															$exited_building_after_time_up_count = sizeof($user_exited_building_after_time_up_list);
															...
															$user_absent_list = array_diff($user_exited_building_list,$user_present_list);
															$user_absent_list = array_values($user_absent_list);
															...
															*/
															...
															<p>Exit Building Start Time: <br>
																<?php echo $exit_building_start_time_date_first; ?>
															</p>
															<p>Exit Building End Time: <br> 
																<?php echo $exit_building_end_time_date_first; ?>
															</p>
															<p>Exit Building Extra Time: <br> 
																<?php echo $exit_building_extra_time_date_first; ?>
															</p>
															
															<p>Attendance Start Time: <br>
																<?php echo $attendance_start_time_date_first; ?>
															</p>
															<p>Attendance End Time: <br>
																<?php echo $attendance_end_time_date_first; ?>
															</p>
...
//IMPORTANT:																							//Change format of am and pm that causes fatal error
																										if (strpos($user_current_beacon_time, 'am') !== false || strpos($user_current_beacon_time, 'pm') !== false) {
																											$user_current_beacon_time_formatted = date('m/d/Y H:i:s',strtotime($user_current_beacon_time));
																										}
																										else{
																											$user_last_beacon_time_before_format = DateTime::createFromFormat($time_format, $user_current_beacon_time);
																											$user_current_beacon_time_formatted =  $user_last_beacon_time_before_format->format('m/d/Y H:i:s');
																										}
																										//echo "User: " . $user_current_beacon_time_formatted . ", " . $exit_building_start_time . "<br> " . $user_current_beacon_time_formatted . ", " . $exit_building_end_time . "<br>";
																										...
																										if (in_array( $user_current_beacon_name, $beacon_exit_list) &&
																											...
																											//echo "User: " . $user_current_beacon_time_formatted . ", " . $exit_building_start_time . ", " . $user_current_beacon_time_formatted . ", " . $exit_building_end_time . "<br>";
																				...
																				for ($in_loop=0; $in_loop<=$in_building_count; $in_loop++){													
																					...
																					if($cursor_in->count() > 0) {
																						...
																						foreach($cursor_in as $still_in)
																						{
																							...
																							$user_beacon_name_before_attendance = "";
																							$user_beacon_time_before_attendance = "";
																							$user_last_beacon_name = "";
																							$user_last_beacon_time = "";
...
//IMPORTANT:																						//Change format of am and pm that causes fatal error
															...
															<?php 
															//$user_exited_building_after_time_up_list 
															//$exited_building_after_time_up_count 
															?>
															<p>Users Exited building After End of Exit Time (Safe): <br>
															<a href="#openModal-<?php echo $fire_alarm_id . "-exit_building_after_end_time_count";?>"><?php echo $exited_building_after_time_up_count;?></a></p>
															<div id="openModal-<?php echo $fire_alarm_id . "-exit_building_after_end_time_count";?>" class="modalDialog">
																	<div>
																		<a href="#close" title="Close" class="close">X</a>
																			...
																			<table class="table table-striped table-bordered table-hover" id="dataTables-example">
																				<thead>
																					<tr>
																						...
																						<th>Exit Detected by Beacon after <?php echo $exit_building_end_time;?></th>
																						<th>Exit Beacon Time after <?php echo $exit_building_end_time;?></th>
																						
																						<th>Last Detected by Beacon Today</th>
																						<th>Last Beacon Time Today</th>
																				...
																				<?php
																				// For loop: based on users listed in $user_absent_list
																				for ($in_loop=0; $in_loop<=$exited_building_after_time_up_count; $in_loop++){													
																					$collection_exit_after_time = new MongoCollection($app_data, 'users');
																					//$criteria_absent = array(	
																					//	'$and' => array(
																					//		array( 'user_id' => $user_absent_list ), 
																					//		array( 'fire_alarm_id'=> $fire_alarm_id )
																					//	)
																					//);																		
																					$query_exit_after_time = array( 'user_id' => $user_exited_building_after_time_up_list[$in_loop] );
																					//echo $user_exited_building_after_time_up_list[$in_loop] . " ";
																					$cursor_exit_after_time = $collection_exit_after_time->find( $query_exit_after_time );
																					if($cursor_exit_after_time->count() > 0) {
																				
																						$in_list_number = $in_loop + 1;
																						foreach($cursor_exit_after_time as $exit_after_time)
																						{
																							//Empty variable values
																							$user_exit_after_beacon_name_attendance = "";
																							$user_exit_after_beacon_time_attendance = "";
																							$user_last_beacon_name = "";
																							$user_last_beacon_time = "";
																							
																							//check values
																							//echo $exit_after_time['user_id'];
																							$exit_after_time_user_id = $exit_after_time['user_id'];
																							$username = $exit_after_time['username'];
																							$full_name = $exit_after_time['full_name'];
																							$role = $exit_after_time['role'];
																							$phone_number = $exit_after_time['phone_number'];																																				
																							...
																							*/																								
																							...
																							if($cursor_user_exit_after_location->count() > 0)
																							{
																								foreach($cursor_user_exit_after_location as $location)
																								{
																									...
																									$user_exit_after_beacon_time_before_format = DateTime::createFromFormat($time_format, $user_exit_after_beacon_time);
																									$user_exit_after_beacon_time_formatted =  $user_exit_after_beacon_time_before_format->format('m/d/Y H:i:s');
																									$user_exit_after_beacon_time_date = $user_exit_after_beacon_time_before_format->format('m/d/Y');																									
																									//Check Date Conversion
																									//echo $user_exit_after_beacon_time_date;
																									
																									if (in_array( $user_exit_after_beacon_name, $beacon_exit_list) || in_array( $user_exit_after_beacon_name, $beacon_assembly_list)){
																										if ($user_exit_after_beacon_time_formatted >= $exit_building_end_time){
																											...
																											//echo "User: " . $user_exit_after_beacon_time_formatted . ", " . $exit_building_start_time . ", " . $exit_building_end_time . "<br>";
																							...
																							$collection_last_location = new MongoCollection($app_data, 'user_location');
																							$criteria_last_location = array(
																								'$and' => array(
																									array( 'user_id' => $exit_after_time_user_id ), 
																									array( 'company_id' => $user_company_id ),	
																									array( 'location_time'=> new MongoRegex('/' . $date. '/i') )
																							...
																							$cursor_last_location = $collection_last_location->find( $criteria_last_location )->sort(array("user_location_id"=>-1))->limit(1);
																							
																							if($cursor_last_location->count() > 0) {
																								foreach($cursor_last_location as $location)
																								{
																									$user_last_beacon_name = $location['beacon_name'];
																									$user_last_beacon_time = $location['location_time'];
																								}
															...
															<p>Users Absent (Exited building but not at Assembly area): <a href="#openModal-<?php echo $fire_alarm_id . "-absent-full";?>"><?php echo $absent_count;?></a></p>											
															<hr>
															<h4>Absent User List
																<i class="fa fa-question-circle user fa-fw tooltips">
...
//IMPORTANT:																							//Change format of am and pm that causes fatal error
																										...
																										//echo $user_current_beacon_time_formatted . ",";
																										if ( in_array( $user_current_beacon_name, $beacon_exit_list) ){
																											if ( $user_current_beacon_time_formatted >= $exit_building_start_time ){
																												//Remove end time limit: && $user_current_beacon_time_formatted <= $attendance_end_time){
																								...
																								/*
																								if ( $user_exit_beacon_name == ""){ $user_exit_beacon_name = "N/A"; }
																								if ( $user_exit_beacon_time == ""){ $user_exit_beacon_time = "N/A"; }
																								if ( $user_last_beacon_name == ""){ $user_last_beacon_name = "N/A"; }
																								if ( $user_last_beacon_time == ""){ $user_last_beacon_time = "N/A"; }
																								*/
																								...
																								$user_exit_beacon_name = "";
																								$user_exit_beacon_time = "";
																								$user_last_beacon_name = "";
																								$user_last_beacon_time = "";
																							}

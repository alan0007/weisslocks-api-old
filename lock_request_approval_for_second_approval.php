...
//If superadmin
if($company_id == 0){
    $data = $LockRequestApprovalForSecondApprovalController->actionIndex();
}else{
    $data = $LockRequestApprovalForSecondApprovalController->actionGetByCompanyId($company_id);
}
?>
<style>
    .navwrap li{
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div style="width:150px;clear:both;padding-left:30px;"><a class="btn btn-lg btn-primary btn-block" href="lock_request_approval_for_second_approval_manage.php"> Add </a></div>
                            ...
                            if($data->count() > 0)
                            {
                                ...
                                { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $lock['from_date']; ?></td>
                                        <td><?php echo $lock['to_date']; ?></td>
                                        <td><?php echo $lock['from_time']; ?></td>
                                        <td><?php echo $lock['to_time']; ?></td>
                                        <td>
                                            <a href="lock_request_approval_for_second_approval.php?id=<?php echo $lock['id']; ?>">  Edit </a>
                                            <a onclick="return confirm('Are you sure?')" href="lock_request_approval_for_second_approval.php?delete=record&id=<?php echo $lock['id']; ?>">  Delete </a>
                                        </td>
                                    </tr>
                                    <?php
                                }
